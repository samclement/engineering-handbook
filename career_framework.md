...
This framework aligns roles across the Individual Contributor (IC) and Management tracks using the following framing from the career-team-reporting Excalidraw:
- Junior → Mid ICs emphasise SDLC execution and craft.
- Staff → Principal ICs add strong technical leadership and cross-team influence.
- Managers carry people/operations responsibilities that dovetail into broader leadership from EM → HoSE → SHoSE.

Each role below lists scope, expected competence, and the crossover into leadership for that level.

## IC Track

### Graduate Software Engineer (GSE)
- **Primary Focus:** Learn the SDLC, quality, and team ways of working.
...
- **Primary Focus:** Deliver small stories end‑to‑end under guidance.
...
- **Primary Focus:** Reliable delivery of features with solid engineering practice.
...
- **Primary Focus:** Technical depth plus velocity; raising the team’s engineering bar.
...
- **Primary Focus:** Technical leadership and cross‑team influence; still hands‑on.
...
- **Primary Focus:** Org‑level technical leadership and strategy; multipliers over teams.
...
- **Primary Focus:** Outcomes through people; delivery, quality, growth, and health.
...
- **Primary Focus:** Multi‑team leadership; strategy, resourcing, and execution at group level.
...
- **Primary Focus:** Org and company‑level leadership across portfolios.
...
- **Junior → Mid IC (GSE → SSE):** Majority focus on SDLC execution (delivery, quality, operability) and craft. Leadership is local (mentoring, raising standards).
- **Staff → Principal IC:** Leadership becomes primary lever: strategy, architecture, cross‑team execution, and stakeholder alignment.
- **Managers (EM → HoSE → SHoSE):** People/operations responsibilities at EM broaden into leadership that mirrors IC leadership at higher altitude: strategy, portfolios, and organisational systems.

## Leveling Signals Matrix (Summary)
- **Scope:**
  - GSE/ASE: tasks → small stories; single component.
  - SE/SSE: component/service ownership; team scope.
  - Staff: product area/platform; multi‑team scope.
  - Principal: portfolio/org; cross‑org scope.
- **Time Horizon:** days → weeks → quarters → year+ → multi‑year.
- **Ambiguity:** low → medium → high → very high.
- **Leadership:** none → local → team → multi‑team/org → company.
- **Technical Judgement:** follows → chooses within patterns → defines patterns → sets direction → sets principles/governance.

## Expectations By Review
For calibration and growth planning, assess against role expectations in three lenses:
- **Outcomes:** Business/customer impact at expected scope and horizon.
- **Execution:** Predictability, quality, reliability, and risk management.
- **Leadership:** Influence, alignment, mentoring, and raising the bar.

Use the Compare & Plan tool in `explorer/` to identify gaps between current and target roles and convert them into a concrete growth plan.
